...
static void test_config_to_user(void)
{
    ...
    g_assert_null( pb_user_get_config(u) );
    g_assert_cmpint( pb_user_set_config(u, c1), ==, -1 );

    c1 = pb_config_new();
    pb_config_from_json_file(c1, "conf/all.json");
    g_assert_cmpint( pb_user_set_config(u, c1), ==, 0 );
...
static void test_get_user_info(void)
{
    ...
    g_assert_cmpint( pb_user_get_info(u), ==, HTTP_UNAUTHORIZED );
}
...
static void test_set_devices(void)
{
    ...
    g_assert_cmpint( pb_user_set_devices(NULL, NULL), ==, -1 );
    g_assert_cmpint( pb_user_set_devices(u, NULL), ==, -1 );
    g_assert_cmpint( pb_user_set_devices(NULL, d), ==, -1 );
    g_assert_cmpint( pb_user_set_devices(u, d), ==, 0 );
...
static void test_get_devices(void)
{
    ...
    g_assert_null( pb_user_get_devices(NULL) );
    g_assert_null( pb_user_get_devices(u) );
